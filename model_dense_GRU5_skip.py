...
def main():
    ...
    x_3 = Flatten()(GRU(args.ncells, return_sequences=True, dropout=args.dropout, recurrent_dropout=args.recurrent_dropout)(add([x_0, x_1, x_2])))

    out_x = Dense(args.delay, activation='linear')(x_3)
    out_y = Dense(args.delay, activation='linear')(x_3)
